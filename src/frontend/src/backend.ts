...
export class Backend implements backendInterface {
    ...
    async addStation(arg0: string, arg1: string, arg2: bigint, arg3: bigint, arg4: bigint): Promise<StationId> {
        if (this.processError) {
            try {
                const result = await this.actor.addStation(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async bookSlot(arg0: StationId, arg1: bigint, arg2: Time): Promise<BookingId> {
        if (this.processError) {
            try {
                const result = await this.actor.bookSlot(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAvailableSlots(arg0: StationId, arg1: Time): Promise<Array<Time>> {
        if (this.processError) {
            try {
